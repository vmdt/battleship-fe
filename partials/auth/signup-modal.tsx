...
type SignupModalProps = {
  ...
  onGoogleSignup?: (authResponse?: any) => void;
  isLoading?: boolean;
};
  ...
  const googleSignup = useGoogleLogin({
    onSuccess: async (response) => {
      try {
        ...
        // Call the parent's onGoogleSignup callback with the auth response
        if (onGoogleSignup) {
          onGoogleSignup(authResponse);
        }
      } catch (error: any) {
    ...
    onError: (error) => {
      ...
      setErrorMessage(t("google_signup_failed"));
    }
  });
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          ...
          {isFormLoading ? t("signing_up") : t("continue_with_google")}
        </Button>
